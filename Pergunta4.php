...
<body>
	...
	<form action="include/action.php" method="post">
		<input type="hidden" name="quiz" value="P4" />
		<input type="hidden" name="id" value="<?=$_GET['id']?>" />
		<div class="">
			<div class="botao-container">
				<p>Já recebeu orientações de onde relizar o descarte de forma correta?</p>
				<button class="botao" name="P4" value="S">Sim</button>
				<button class="botao" name="P4" value="N">Não</button>
				<div>&nbsp;</div>
			</div>
		</div>
	</form>
