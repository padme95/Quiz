...
<body>
	...
	<form action="include/action.php" method="post">
		<input type="hidden" name="quiz" value="P2" />
		<input type="hidden" name="id" value="<?=$_GET['id']?>" />
		<div class="">
			<div class="botao-container">
				<div>&nbsp;</div>
				<p>Existem pontos de coleta em seu bairro?</p>
				<button class="botao" name="P2" value="S">Sim</button>
				<button class="botao" name="P2" value="N">Não</button>
				<div>&nbsp;</div>
			</div>
		</div>
	</form>
