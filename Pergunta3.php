...
<body>
	...
	<form action="include/action.php" method="post">
		<input type="hidden" name="quiz" value="P3" />
		<input type="hidden" name="id" value="<?=$_GET['id']?>" />
		<div class="">
			<div class="botao-container">
				<p>Você leva pilhas e baterias aos pontos de coleta?</p>
				<button class="botao" name="P3" value="S">Sim</button>
				<button class="botao" name="P3" value="N">Não</button>
				<div>&nbsp;</div>
			</div>
		</div>
	</form>
